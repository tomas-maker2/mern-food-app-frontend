import { Order, OrderStauts } from "@/types";
    ...
    <Card>
      ...
      <CardContent className="flex flex-col gap-6">
        ...
        <div className="flex flex-col space-y-1.5">
          <Label htmlFor="status">What is the stauts of the order?</Label>
          <Select
            value={status}
            disabled={isLoading}
            onValueChange={(value) => handleStatusChange(value as OrderStauts)}
          >
